---
name: probe-mcp-none
description: TEMPORARY DIAGNOSTIC — probes MCP tool availability for a sub-agent (variant D — control, NO mcp entry at all). Delete after the experiment concludes. Not part of the Trellis workflow.
tools: Read, Bash
model: haiku
---
# Tool Probe — variant D — control, NO mcp entry at all
